...
$servers->setValue('server','name','LoopBack-World');
...
$servers->setValue('server','host','loopback.world');
...
$servers->setValue('login','bind_id','cn=admin,dc=loopback,dc=world');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
// $servers->setValue('login','bind_pass','');
$servers->setValue('login','bind_pass','naked');
