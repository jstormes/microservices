...
#    && docker-php-ext-enable swoole
# Split the config into cli and apache
RUN cp -r /usr/local/etc/php/conf.d/ /usr/local/etc/php/conf.apache.d/
...
RUN yes | pecl install xdebug \
    && echo "zend_extension=$(find /usr/local/lib/php/extensions/ -name xdebug.so)" > /usr/local/etc/php/conf.apache.d/xdebug.ini \
    && echo "xdebug.remote_enable=on" >> /usr/local/etc/php/conf.apache.d/xdebug.ini \
    && echo "xdebug.remote_autostart=on" >> /usr/local/etc/php/conf.apache.d/xdebug.ini \
    && echo "xdebug.remote_host=host.docker.internal" >> /usr/local/etc/php/conf.apache.d/xdebug.ini
...
#ENV PHP_INI_SCAN_DIR /usr/local/etc/php/conf.apache.d
